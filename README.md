...
<div style="display: flex; justify-content: space-between; align-items: center;">
    <div style="text-align: center; margin-right: 20px;">
        <img src="images/brick_WDH.jpg" alt="Pallet Overview" width="350">
        <p><em>Figure 1: Overview of the brick</em></p>
    </div>
    <div style="text-align: center; margin-left: 20px;">
        <img src="images/brick_detail.jpg" alt="Pallet Dimensions" width="350">
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 30px;">
    <div style="text-align: center;">
        <img src="images/pallet.jpg" alt="Pallet Dimensions" width="350">
